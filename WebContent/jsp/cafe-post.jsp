...
<div id="post-content" style="border: 1px solid black; padding:10px;">
	...
	<p style="font-size: 0.8em;margin-top:10px;">작성자 : <a href="${pageContext.request.contextPath }/message?messageUserNum=${postInfo['userNum']}" onClick="window.open(this.href, '', 'width=450, height=650'); return false;">${postInfo['userName'] }</a></p>
