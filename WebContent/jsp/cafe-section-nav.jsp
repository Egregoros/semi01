...
<div id="section-nav-header">
	...
	<div id="section-nav-header-content">
		<div id="section-nav-header-content-cafe">
			<div>
				<p class="gray"><a href="${pageContext.request.contextPath }/message?messageUserNum=${cafeInfo['cafeAdminNum']}" onClick="window.open(this.href, '', 'width=450, height=650'); return false;" style="color:gray;">${cafeInfo['cafeAdmin'] }</a>&nbsp;&nbsp;<c:if test="${userNum==cafeInfo['cafeAdminNum'] }"><a href="${pageContext.request.contextPath }/cafe/CafeUpdateMain.jsp?cafeNum=${cafeInfo['cafeNum'] }" class="underline" style="font-size: 0.8em; color:#3e3e3e;">[관리]</a></c:if></p>
